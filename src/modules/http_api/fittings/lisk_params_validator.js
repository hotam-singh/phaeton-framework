...
const debug = require('debug')('swagger:phaeton:params_validator');
 ...
 * @returns {function} {@link api.fittings.phaeton_params_validator}
...
module.exports = function create() {
	 ...
	 * Description of the function.
	 *
	 * @func phaeton_params_validator
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function phaeton_params_validator(context, cb) {
		let error = null;
