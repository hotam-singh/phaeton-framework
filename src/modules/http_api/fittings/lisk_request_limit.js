...
const debug = require('debug')('swagger:phaeton:request_limit');
 ...
 * @returns {function} {@link api.fittings.phaeton_request_limit}
...
module.exports = function create(fittingDef) {
	 ...
	 * @todo Add description for the function and the params
	 */
	function phaeton_request_limit(context, cb) {
		debug('exec');
		middleware(context.request, context.response, cb);
	}

	phaeton_request_limit.limits = limits;
	phaeton_request_limit.defaults = defaults;

	return phaeton_request_limit;
};
